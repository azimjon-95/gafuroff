...
const formatCurrency = (amount, locale = "uz-UZ", currency = "UZS") =>
  Number(amount)?.toLocaleString(locale, { style: "currency", currency }) ||
  "0 so'm";
...
function ModelCheck({ contentRef, data: story }) {
  ...
  const clinicInfo = {
    ...
    logo: getSafe(clinics, ["innerData", "logo"], "N/A"),
    contacts: getSafe(clinics, ["innerData", "phone"], ["N/A"]),
    time: `${getSafe(
      clinics,
      ["innerData", "work_schedule", "start_time"],
      "N/A"
    )} - ${getSafe(
      clinics,
      ["innerData", "work_schedule", "end_time"],
      "N/A"
    )}`,
  };
  ...
  return (
    <div ref={contentRef} className="receipt-container-component">
      ...
      <div className="contact-details-section">
        ...
        <div className="contact-information-block">
          <strong>Qabul vaqti:</strong> {clinicInfo.time}
        </div>
      </div>
        ...
        <div className="information-row-container">
          ...
          <span className="information-value-text">
            {capitalizeFirstLetter(
              getSafe(story, ["response", "doctor", "specialization"], "N/A")
            )}
          </span>
        </div>
        <div className="information-row-container">
          ...
          <span className="information-value-text">
            {getSafe(story, ["response", "doctor", "firstName"], "N/A")}{" "}
            {getSafe(story, ["response", "doctor", "firstName"], "N/A")}
          </span>
        </div>
        <div className="information-row-container">
          ...
          <span className="information-value-text">
            {getSafe(story, ["response", "doctor", "phone"], "N/A")}
          </span>
        </div>
        <br />
        <div className="information-row-container">
          ...
          <span className="information-value-text">
            {getSafe(story, ["response", "patient", "firstname"], "N/A")}{" "}
            {getSafe(story, ["response", "patient", "lastname"], "N/A")}
          </span>
        </div>
        <div className="information-row-container">
      ...
      <div className="footer-content-section">
        <div className="order-number-display">
          {getSafe(story, ["response", "patient", "order_number"], "N/A")}
        </div>
        <div className="footer-content-text">
          <strong>Sizning navbatingiz!</strong>
        </div>
